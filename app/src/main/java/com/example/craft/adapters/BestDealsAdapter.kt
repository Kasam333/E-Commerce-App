...
import com.example.craft.databinding.BestDealsRvItemBinding
        ...
        fun bind(product: Product) {
            binding.apply {
                ...
                product.offerPercentage?.let {
                    ...
                    val priceAfterOffer = (product.price * 100) / remainingPricePercentage
                    tvOldPrice.text = "${String.format("%.1f",priceAfterOffer)}%\nOff"
                }
